...
docker compose exec -T redis sh -lc 'redis-cli < /dev/stdin > /dev/null' < cache/posts.txt
...
docker compose exec -T redis sh -lc 'redis-cli < /dev/stdin > /dev/null' < cache/users.txt
...
docker compose exec -T redis sh -lc 'redis-cli < /dev/stdin > /dev/null' < cache/feeds.txt
